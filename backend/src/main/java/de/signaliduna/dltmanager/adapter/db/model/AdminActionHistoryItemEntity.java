...
public record AdminActionHistoryItemEntity(
	String userName,
	...
	public static final class Builder {
		...
		public AdminActionHistoryItemEntity build() {
			return new AdminActionHistoryItemEntity(this.userName, this.timestamp, this.actionName,
